...
public class leaderboard extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (ID == R.id.n_home) {
            Intent intent=new Intent(leaderboard.this,OrganisationHome.class);
            startActivity(intent);
        }else if (ID == R.id.n_feed) {
            Intent intent = new Intent(leaderboard.this, Post.class);
            startActivity(intent);
        }
        else if (ID == R.id.n_no) {
            Intent intent=new Intent(leaderboard.this,Notification.class);
            startActivity(intent);

        } else if (ID == R.id.nList) {
            Intent intent=new Intent(leaderboard.this, VolunteerList.class);
            startActivity(intent);

        } else if (ID == R.id.onList) {
            Intent intent=new Intent(leaderboard.this, Olist.class);
            startActivity(intent);

        } else if (ID == R.id.n_profile) {
            Intent profile = new Intent(leaderboard.this, OrgProfile.class);
